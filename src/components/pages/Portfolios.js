    ...
    return (
        <div>
            <section class="container">
                ...
                <div class="row">
                    <div class="col-md">
                        <h2 class="text-center project-title">Odyssey</h2>
                        <img class="img-fluid" src={OdysseyImg} alt="Odyssey pic"></img>
                        <p class="text-center"> - Odyssey is a scrapbooking travel app that allows the user to create
                    ...
                    jawsDB database.</p>
                        <h5 class="text-center">You can visit the site <a href="https://team-zeus.herokuapp.com/"
                            target="_blank" rel="noreferrer">Here!</a></h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md">
                        <h2 class="text-center project-title">MusikinSite</h2>
                        <img class="img-fluid" src={MusikinSiteImg} alt="MusikinSite pic"></img>
                        <p class="text-center"> - A functional music search engine that will take in user's song input via the
                    ...
                    api.</p>
                        <h5 class="text-center">You can visit the site <a href="https://sltang0815.github.io/MusikinSite/"
                            target="_blank" rel="noreferrer">Here!</a></h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md">
                        <h2 class="text-center project-title">Weather Dashboard</h2>
                        <img class="img-fluid" src={WeatherDashboardImg} alt="Weather Dashboard pic"></img>
                        <p class="text-center"> - An application that lets you see weather for any given city. The site will
                    ...
                    OpenWeather's weather api.</p>
                        <h5 class="text-center">You can visit the site <a href="https://alhoffiq.github.io/weatherDashboard/"
                            target="_blank" rel="noreferrer">Here!</a></h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md">
                        <h2 class="text-center project-title">Hourly Schedule App</h2>
                        <img class="img-fluid" src={SchedulerImg} alt="Weather Dashboard pic"></img>
                        <p class="text-center"> - A simple application to keep track of tasks needed to be complete throughout
                    ...
                    much time is left for future tasks and which task is running out of time to complete</p>
                        <h5 class="text-center">You can visit the site <a href="https://alhoffiq.github.io/calendarApp/"
                            target="_blank" rel="noreferrer">Here!</a></h5>
                    </div>
                </div>
